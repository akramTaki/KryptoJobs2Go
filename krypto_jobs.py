...
# Write the client's Ethereum account balance to the sidebar
...
# Calculate total `wage` for the candidate by multiplying the candidate’s hourly rate
...
if st.sidebar.button("Send Transaction"):
    # Send the transaction and store the transaction hash
